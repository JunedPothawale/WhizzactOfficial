    ...
    <nav class="navbar navbar-expand-lg shadow-0 position-fixed w-100">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <ul class="navbar nav border-0 shadow-0 ">
                <li class="nav-item">
                    <a class="nav-link text-white links" href="index.php">Home</a>
                </li>
                <li class="nav-item dropdown position-static">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white links " href="whyWhizzact.php">Why WhizzAct</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white  links " href="industry.php">Industry</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white links " href="company.php">Company</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white links " href="contact.php">Contact</a>
                </li>
                <li class="nav-item">
